...
describe('quartilExc', () => {
  it('deve aceitar array', () => {
    expect(quartilExc([6, 7, 15, 36, 39, 40, 41, 42, 43, 47, 49], 1)).toEqual(
      15
    );
    expect(quartilExc([6, 7, 15, 36, 39, 40, 41, 42, 43, 47, 49], 3)).toEqual(
      43
    );
    expect(quartilExc([25, 26, 225, 24, 23, 24, 25, 325, 28, 27], 1)).toEqual(
      24
    );
